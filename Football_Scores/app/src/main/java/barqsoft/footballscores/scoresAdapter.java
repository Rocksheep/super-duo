...
public class scoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        viewHolder.home_name.setText(cursor.getString(COL_HOME));
        viewHolder.away_name.setText(cursor.getString(COL_AWAY));
        ...
        viewHolder.home_crest.setImageResource(Utilies.getTeamCrestByTeamName(
                cursor.getString(COL_HOME)));
        viewHolder.away_crest.setImageResource(Utilies.getTeamCrestByTeamName(
                cursor.getString(COL_AWAY)
        ));

        final String contentDescription = createContentDescription(viewHolder);
        ...
        if(viewHolder.match_id == detail_match_id)
        {
            ...
            share_button.setOnClickListener(new View.OnClickListener() {
                ...
                {
                    //add Share Action
                    context.startActivity(createShareForecastIntent(context, contentDescription + " "));
                }
            });
        }
        else
    ...
    public Intent createShareForecastIntent(Context context, String ShareText) {
        ...
        String hashTag = context.getString(R.string.share_hashtag);
        shareIntent.putExtra(Intent.EXTRA_TEXT, ShareText + hashTag);
        return shareIntent;
    }

    private String createContentDescription(ViewHolder viewHolder) {
        return viewHolder.home_name.getText() + " "
